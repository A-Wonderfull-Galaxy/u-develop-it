...
//originally app.get('/api/candidates/:id')
...
//originally app.post('/api/candidate/:id)
...
//original app.put('/api/candidate/:id')
router.put('/api/candidate/:id', (req, res) =>{
    ...
    db.query(sql, params, (res, result) =>{
        if (err){
            res.status(400).json({ error: err.message });
...
//original app.delete('/candidate/:id')
